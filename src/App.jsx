...
const PWAInstallPrompt = ({ show, onInstall, onHide }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-lg z-50 animate-slideUp">
      <div className="flex items-center justify-between max-w-md mx-auto">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-bold text-gray-800">Install WhatsApp Support</h3>
